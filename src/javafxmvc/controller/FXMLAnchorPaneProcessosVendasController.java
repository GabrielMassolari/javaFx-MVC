        ...
        if(venda != null){
            ...
            if(buttonConfirmarClicked){
                try{
                    ...
                    for(ItemDeVenda itemDeVendaRemover : itemDeVendaDAO.listarPorVenda(venda)){
                    ...
                    for(ItemDeVenda itemDeVendaInserir : venda.getItensDeVenda()){
                        Produto produto = produtoDAO.buscar(itemDeVendaInserir.getProduto());
                        itemDeVendaInserir.setVenda(venda);
                        itemDeVendaDAO.inserir(itemDeVendaInserir);
                        produto.setQuantidade(produto.getQuantidade() - itemDeVendaInserir.getQuantidade());
                        produtoDAO.alterar(produto);
                    }
                    connection.commit();
                    carregarTableViewVendas();
